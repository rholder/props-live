 ...
 * {@link PropConfigImpl#PropConfigImpl() system properties}. A static instance of that is available on this interface
 * as {@link #$}
 *
 * @author jason
 */
public interface PropConfig {
    ...
    public static final PropConfig $ = new PropConfigImpl();
